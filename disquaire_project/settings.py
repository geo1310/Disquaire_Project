...
Cours Openclassrooms : Découvrez le Framework Django
Georges Briche le 10 Janvier 2020
...
''' génération clé dans console python
$ python
...
#  Traduction Middleware: logiciel migrateur, intergiciel
...
MIDDLEWARE = [
    ...
    'django.middleware.locale.LocaleMiddleware', # intergiciel pour importation des traductions
    'debug_toolbar.middleware.DebugToolbarMiddleware', # barre debug dans explorateur
